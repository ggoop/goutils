...
func (s *UIFilters) MD() *Mder {
	return &Mder{ID: "md.ui.filters", Domain: md_domain, Name: "过滤器"}
}

type UIFilterSolution struct {
	ID        string      `gorm:"primary_key;size:36" json:"id"`
	CreatedAt utils.Time  `gorm:"name:创建时间" json:"created_at"`
	UpdatedAt utils.Time  `gorm:"name:更新时间" json:"updated_at"`
	EntID     string      `gorm:"size:36;name:企业" json:"ent_id"`
...
func (s *UIFilterSolution) MD() *Mder {
	return &Mder{ID: "md.ui.filter.solution", Domain: md_domain, Name: "过滤方案"}
}

type UIFilterItem struct {
	ID          string      `gorm:"primary_key;size:36" json:"id"`
	CreatedAt   utils.Time  `gorm:"name:创建时间" json:"created_at"`
	UpdatedAt   utils.Time  `gorm:"name:更新时间" json:"updated_at"`
	EntID       string      `gorm:"size:36;name:企业" json:"ent_id"`
...
func (s *UIFilterItem) MD() *Mder {
	return &Mder{ID: "md.ui.filter.item", Domain: md_domain, Name: "过滤项"}
}
